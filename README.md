...
extending [CUCoreLib](https://github.com/jimmyking9999999/CUCoreLib) (CCL) with additional tools and constants for mod
...
Bark uses [CUCoreLib](https://github.com/jimmyking9999999/CUCoreLib)'s [
`LocaleRegistry`](https://github.com/jimmyking9999999/CUCoreLib) for all localization. No separate locale setup is
needed.
...
This writes to `BepInEx/config/CUCoreLib/Locales/EN.json`. Translators can then create language-specific files (e.g.
`CN-zh.json`).
...
All localization in Bark is handled by [CUCoreLib](https://github.com/jimmyking9999999/CUCoreLib)'s [
`LocaleRegistry`](https://github.com/jimmyking9999999/CUCoreLib).
